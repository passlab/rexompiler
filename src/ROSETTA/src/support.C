...
//#endif
  ...
  // DQ (10/10/2020): List of extra include paths to be inserted before the users include paths.
     SourceFile.setDataPrototype("SgStringList","extraIncludeDirectorySpecifierBeforeList", "",
                           NO_CONSTRUCTOR_PARAMETER, BUILD_LIST_ACCESS_FUNCTIONS, NO_TRAVERSAL, NO_DELETE);
  // DQ (10/10/2020): List of extra include paths to be inserted after the users include paths.
     SourceFile.setDataPrototype("SgStringList","extraIncludeDirectorySpecifierAfterList", "",
                           NO_CONSTRUCTOR_PARAMETER, BUILD_LIST_ACCESS_FUNCTIONS, NO_TRAVERSAL, NO_DELETE);
...
#warning "ROSE_USING_GRAPH_IR_NODES_FOR_BACKWARD_COMPATABILITY not set"
  ...
  // tps : TODO : This will be eliminated because it is redundant with the AstAttributeMechanism.
     ...
     OmpFlowGraphNode.setDataPrototype("SgNode*", "end_statement", "= NULL",
                       NO_CONSTRUCTOR_PARAMETER, BUILD_ACCESS_FUNCTIONS, DEF_TRAVERSAL, NO_DELETE, CLONE_PTR);
     OmpFlowGraphNode.setDataPrototype("int", "cost", "= 0",
                       NO_CONSTRUCTOR_PARAMETER, BUILD_ACCESS_FUNCTIONS, NO_TRAVERSAL, NO_DELETE);
